...
export default function HomePage() {
  return (
    <>
      <Head>
        {/* Basic Meta */}
        <title>StudioIn Wedding Stories | Best Wedding & Event Photography Nagercoil</title>
        <meta
          name="description"
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "StudioIn Wedding Stories offers professional wedding, pre-wedding, birthday, and event photography in Nagercoil, Kanyakumari, Trivandrum, Tirunelveli & nearby. Capturing timeless memories beautifully.",
              "areaServed": [
                "Nagercoil",
                "Kanyakumari",
                "Trivandrum",
