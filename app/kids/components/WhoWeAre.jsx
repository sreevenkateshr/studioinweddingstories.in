  ...
  return (
    <section className="bg-white py-20 px-4">
      ...
      <div className="text-center mb-16">
        <h2 className="text-3xl md:text-4xl font-serif tracking-[0.3em] font-light text-gray-800 uppercase">
          Who We Are
        </h2>
       <p className="mt-4 italic text-gray-500 text-center max-w-2xl mx-auto leading-relaxed">
  Capturing timeless moments with creativity and care, our photography blends
  natural emotions, thoughtful composition, and professional storytelling to
  deliver memories you’ll cherish forever.
</p>
      </div>
